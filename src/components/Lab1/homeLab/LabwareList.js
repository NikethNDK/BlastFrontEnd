...
//       try {
//         const data = await getMasterLabwareApi();
//         if (mounted) {
...
//       (master.item_code && master.item_code.toLowerCase().includes(itemCodeFilter.toLowerCase())) &&
//       (master.item_name && master.item_name.toLowerCase().includes(itemNameFilter.toLowerCase()))
//     );
//   };

//   useEffect(() => {
//     setFilteredMasters(filterMasters());
//   }, [itemCodeFilter, itemNameFilter, masters]);
...
//                   />
//                 </th>
//                 <th style={{ backgroundColor: '#C5EA31', width: '250px', color: 'black', textAlign: 'center', border: '1px solid black' }}>Stock</th>
//                 <th style={{ backgroundColor: '#C5EA31', width: '250px', color: 'black', textAlign: 'center', border: '1px solid black' }}>Units</th>
//                 <th style={{ backgroundColor: '#C5EA31', width: '250px', color: 'black', textAlign: 'center', border: '1px solid black' }}>Price</th>
//                 <th style={{ backgroundColor: '#C5EA31', width: '250px', color: 'black', textAlign: 'center', border: '1px solid black' }}>Make</th>
//                 <th style={{ backgroundColor: '#C5EA31', width: '250px', color: 'black', textAlign: 'center', border: '1px solid black' }}>Instruction/ Specification</th>
//                 <th style={{ backgroundColor: '#C5EA31', width: '250px', color: 'black', textAlign: 'center', border: '1px solid black' }}>Min Req Stock</th>
//                 <th style={{ backgroundColor: '#C5EA31', width: '250px', color: 'black', textAlign: 'center', border: '1px solid black' }}>Quantity Received</th>
//                 <th style={{ backgroundColor: '#C5EA31', width: '250px', color: 'black', textAlign: 'center', border: '1px solid black' }}>Quantity Issued</th>
//                 <th style={{ backgroundColor: '#C5EA31', width: '250px', color: 'black', textAlign: 'center', border: '1px solid black' }}>Location Code</th>
//                 <th style={{ backgroundColor: '#C5EA31', width: '250px', color: 'black', textAlign: 'center', border: '1px solid black' }}>Remarks</th>
...
//                 <tr key={master.c_id}>
//                   <td style={{ textAlign: 'center', border: '1px solid black' }}>{master.item_code}</td>
//                   <td style={{ textAlign: 'center', border: '1px solid black' }}>{master.item_name}</td>
//                   <td style={{ textAlign: 'center', border: '1px solid black' }}>{master.quantity}</td>
//                   <td style={{ textAlign: 'center', border: '1px solid black' }}>{master.units}</td>
//                   <td style={{ textAlign: 'center', border: '1px solid black' }}>{master.price}</td>
//                   <td style={{ textAlign: 'center', border: '1px solid black' }}>{master.make}</td>
//                   <td style={{ textAlign: 'center', border: '1px solid black' }}>{master.instruction_specification}</td>
//                   <td style={{ textAlign: 'center', border: '1px solid black' }}>{master.min_req_stock}</td>
//                   <td style={{ textAlign: 'center', border: '1px solid black' }}>{master.quantity_received}</td>
//                   <td style={{ textAlign: 'center', border: '1px solid black' }}>{master.quantity_issued}</td>
//                   <td style={{ textAlign: 'center', border: '1px solid black' }}>{master.location_code}</td>
//                   <td style={{ textAlign: 'center', border: '1px solid black' }}>{master.remarks}</td>
            ...
            <tbody>
              {filteredMasters.map((master) => (
                <tr key={master.c_id}>
                  ...
                  {/* <td style={{ textAlign: 'center', border: '1px solid black' }}>{master.manufacturer}</td> */}
                  {/* <td style={{ textAlign: 'center', border: '1px solid black' }}>{master.supplier}</td>                   */}
                  {/* <td style={{ textAlign: 'center', border: '1px solid black' }}>{master.instruction_specification || '-'}</td> */}
                  <td
                    style={{ textAlign: "center", border: "1px solid black" }}
                  >
