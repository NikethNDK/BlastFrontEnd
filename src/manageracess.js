...
// function ManagerAccessApp({
//   userId,
//   userDetails = { name: "", lab: "", designation: "" },
// }) {
//   return (
//     <BrowserRouter>
//       {/* <ManagerAccessNavigation /> */}
//       <Routes>
//         <Route path="/" element={<Join userDetails={userDetails} />} />
//         <Route
//           exact
//           path="/dashboard"
//           element={<Dasboard userDetails={userDetails} />}
//         />
//         <Route
//           exact
//           path="/project"
//           element={<Project userDetails={userDetails} />}
//         />
//         <Route
//           path="/manager/appinfo"
//           element={<AppinfoManager userDetails={userDetails} />}
//         />

//         <Route
//           path="/manager/master"
//           element={<ChemicalManager userDetails={userDetails} />}
//         />
//         <Route
//           path="/manager/master_filter"
//           element={<MasterFilter userDetails={userDetails} />}
//         />

//         <Route
//           path="/manager/inventory"
//           element={<InventoryManager userDetails={userDetails} />}
//         />

//         <Route
//           path="/notification"
//           element={<Notification userDetails={userDetails} />}
//         />
//         <Route
//           path="/view_entry"
//           element={<ViewEntry userDetails={userDetails} />}
//         />

//         <Route
//           path="/return_data"
//           element={<ReturnDataTable userDetails={userDetails} />}
//         />
//         <Route
//           path="/change_password"
//           element={<ChangePassword userDetails={userDetails} />}
//         />
//         <Route
//           path="/returnNoti"
//           element={<ReturnDataTableNotification managerId={userId} />}
//         />
//       </Routes>
//     </BrowserRouter>
//   );
...
// export default ManagerAccessApp;
import React from "react";
import "bootstrap/dist/css/bootstrap.min.css";
import Home from "./components/Home";
import ManagerAccessNavigation from "./components/manager/acessnavigation";
...
function Layout({ userId, userDetails }) {
  ...
  return (
    <>
      {!hideNavigation && <ManagerAccessNavigation userDetails={userDetails}/>}
      <Routes>
